...
const sayHelloBackground = () => {
  //let e = document.querySelector("#say-hello-button");
  // sayHelloButton.classList.add("");
  sayHelloButton.style.backgroundColor = "black";
  sayHelloButton.style.color = "white";

  //sayHelloButton.onMouseOver;
};
...
function sayHelloColors() {
  sayHelloButton.style.backgroundColor = "#EFEFEF";
  sayHelloButton.style.color = "black";
}

sayHelloButton.addEventListener("mouseout", sayHelloColors);
...
const repeatMyParam = () => {
  //YOUR CODE HERE
  axios.get("http://localhost:3000/repeat/animals").then((res) => {
    console.log(res.data);
...
const myFunction = () => {
  axios.get("http://localhost:3000/query-test/?animals=cat").then((res) => {
    console.log(res.data);
  });
};

let queryBtn = document.querySelector("#query-button");
queryBtn.addEventListener("click", myFunction);
